...
## [4.0.0-beta.1](https://github.com/sulhadin/orchestrator/compare/orchestrator-v3.0.0-beta.1...orchestrator-v4.0.0-beta.1) (2026-03-30)
...
* **orchestra:** add /orchestra create-role command ([579cb97](https://github.com/sulhadin/orchestrator/commit/579cb972633e1492ba8a20e51bb7e875a4ca03f1))
...
* **orchestra:** add orchestrator agent with role creation via symlink ([7913088](https://github.com/sulhadin/orchestrator/commit/791308861f52bc9b535c7114dd79e7c24c2b4677))
...
* **orchestra:** symlink all roles as agents for standalone access ([b503c7b](https://github.com/sulhadin/orchestrator/commit/b503c7b92dc50c7f66ca1cc21d2cd9eb16a60b37))
...
* **ci:** clean release-please config — let it auto-detect version ([ec23c7c](https://github.com/sulhadin/orchestrator/commit/ec23c7c346886ae7082b782f2640c6af05cb5568))
* **ci:** force 3.0.0-beta.2 release-as ([bbe5695](https://github.com/sulhadin/orchestrator/commit/bbe5695830d52ea6c34a3cb0649f5d653e13508e))
* **ci:** remove release-as and last-release-sha overrides for future betas ([853fcba](https://github.com/sulhadin/orchestrator/commit/853fcbadf2dc713c121fa006ef067da27a78e1da))
* **next:** release orchestrator 3.0.0-beta.1 ([#6](https://github.com/sulhadin/orchestrator/issues/6)) ([1b8b854](https://github.com/sulhadin/orchestrator/commit/1b8b854c680b5051b6fe1420e75f3593531faeba))
* **next:** release orchestrator 3.0.0-beta.1 ([#7](https://github.com/sulhadin/orchestrator/issues/7)) ([4f602f8](https://github.com/sulhadin/orchestrator/commit/4f602f8a67c655b60e58ae73fe7e5d91496895b1))
...
* retrigger release-please ([86f8bf4](https://github.com/sulhadin/orchestrator/commit/86f8bf49b5442de684ad75134ea14b5ddf1e3785))
* trigger release-please ([1a51110](https://github.com/sulhadin/orchestrator/commit/1a51110b3920c7bb74154db2039c38a970f51141))

## [3.0.0-beta.1](https://github.com/sulhadin/orchestrator/compare/orchestrator-v3.0.0-beta.1...orchestrator-v3.0.0-beta.1) (2026-03-30)
...
* initialize project with editor, git, and Yarn configurations. ([d406df0](https://github.com/sulhadin/orchestrator/commit/d406df0adeeae40871ff667a697b9fc7dcab759c))
* **orchestra:** add /orchestra commands as native Claude Code commands ([5607403](https://github.com/sulhadin/orchestrator/commit/5607403ce9390531d46a021e20236c3737c9c4f7))
* **orchestra:** add /orchestra create-role command ([e50bbe7](https://github.com/sulhadin/orchestrator/commit/e50bbe70c2d8787830186eb99270d01f581ae2f6))
* **orchestra:** add conductor and reviewer agents, remove worker ([0926d41](https://github.com/sulhadin/orchestrator/commit/0926d4158061fcf0870907f1c4cf06d9187df89b))
* **orchestra:** add config-driven pipeline (.orchestra/config.yml) ([9927e0c](https://github.com/sulhadin/orchestrator/commit/9927e0c73170f6f4125a26ee8534da9b3ccb3e45))
* **orchestra:** add context.md update to all role handoffs and token column to status report ([0c49954](https://github.com/sulhadin/orchestrator/commit/0c4995464d536951df7d2ccfc5879fe1d0756068))
* **orchestra:** add orchestrator agent with role creation via symlink ([6170465](https://github.com/sulhadin/orchestrator/commit/6170465597e97c68942404df07007e64d9d76052))
* **orchestra:** extract discipline rules to .claude/rules/*.orchestra.md ([b68e5d9](https://github.com/sulhadin/orchestrator/commit/b68e5d9865b5c1aa9c34965bb44705c8483cb2a4))
* **orchestra:** migrate skills to .claude/skills/*.orchestra.md ([11413f5](https://github.com/sulhadin/orchestrator/commit/11413f51ce43cd0f32ba58707e7502b94a3df4e5))
* **orchestra:** symlink all roles as agents for standalone access ([48ac033](https://github.com/sulhadin/orchestrator/commit/48ac033d9f1afec57d7f4d5507b1141faddba80c))
* **orchestra:** sync template with v3 architecture ([97b841f](https://github.com/sulhadin/orchestrator/commit/97b841f3fbb3eafa77ddd806e9e9c13187f2e03a))
* **orchestra:** update CLAUDE.md, README, installer for v3 architecture ([c5ea61d](https://github.com/sulhadin/orchestrator/commit/c5ea61d1a83118e4549b6ac77dffd5041eca74c2))
* worker agent autonomously activates roles and executes phases, clarifying automatic role switching based on phase files. ([a452555](https://github.com/sulhadin/orchestrator/commit/a452555680380ee8c631b4674717c2cd763b640c))
